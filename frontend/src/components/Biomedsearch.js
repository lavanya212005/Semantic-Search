...
function ArticleCard({ article, rank }) {
  ...
  const { title, authors, journal, publication_date, abstract, relevance_score, pubmed_url } = article;
  ...
  return (
    <li className="article-card" style={{ borderLeft: `3px solid ${tier.color}` }}>
      ...
      <div className="article-footer">
        {pubmed_url ? (
          <a href={pubmed_url} target="_blank" rel="noreferrer" className="article-link">
            View on PubMed
...
export default function App() {
  ...
  return (
    <div className="App">
      <style>{`
        .App { min-height: 100vh; background: radial-gradient(circle at top, rgba(47,110,98,0.12), transparent 28%), linear-gradient(180deg, #f3efe8 0%, #eef2ee 100%); color: ${ink}; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif; padding: 2rem 1.25rem 4rem; }
        ...
        .App-title { font-family: 'Iowan Old Style','Palatino Linotype','Book Antiqua',Georgia,serif; font-size: 36px; font-weight: 600; color: ${ink}; margin: 0; }
        .App-subtitle { font-size: 14px; color: ${inkSoft}; margin: 8px 0 0; }
        .search-form { background: linear-gradient(180deg, rgba(248,248,244,0.98), rgba(240,244,239,0.95)); border: 1px solid rgba(27,42,51,0.08); border-radius: 16px; padding: 1rem 1rem 0.85rem; margin-bottom: 1.5rem; box-shadow: inset 0 1px 0 rgba(255,255,255,0.7); }
        ...
        .search-input { flex: 1; border: none; outline: none; background: transparent; font-size: 15px; color: ${ink}; }
        ...
        .primary-button:focus-visible, .search-input:focus-visible, .filter-select:focus-visible, .article-expand:focus-visible, .article-link:focus-visible, .pagination button:focus-visible { outline: 2px solid ${teal}; outline-offset: 2px; }
        ...
        .filter-select { font-size: 13px; color: ${ink}; background: #EFF2EF; border: 0.5px solid ${line}; border-radius: 3px; padding: 4px 8px; cursor: pointer; }
        ...
        .article-title { font-family: 'Iowan Old Style','Palatino Linotype','Book Antiqua',Georgia,serif; font-size: 19px; font-weight: 600; color: ${ink}; line-height: 1.35; margin: 0 0 4px; }
        .article-authors { font-family: 'Iowan Old Style','Palatino Linotype','Book Antiqua',Georgia,serif; font-style: italic; font-size: 13.5px; color: ${inkSoft}; margin: 0 0 10px; }
